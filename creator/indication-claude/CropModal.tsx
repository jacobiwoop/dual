...
interface CropModalProps {
  isOpen: boolean;
  onClose: () => void;
  imageSrc: string;          // URL ou dataURL de l'image à recadrer
  aspect: '1:1' | '16:9';   // ratio imposé selon le type
          ...
          <div className="px-6 py-4 border-t border-gray-100 space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-xl text-sm font-medium transition-colors"
                >
                  <RotateCw size={15} className="scale-x-[-1]" /> -90°
                </button>
                <button
                  onClick={() => setRotation(r => r + 90)}
                  className="flex items-center gap-1.5 px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-xl text-sm font-medium transition-colors"
                ...
                <button
                  ...
                  className="px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-xl text-xs font-medium text-gray-500 transition-colors"
                >
                  Reset
                </button>
              </div>
            ...
            <div className="flex gap-3 pt-1">
              ...
              <button
                onClick={handleCrop}
                disabled={!imgLoaded}
                className="flex-1 py-3 bg-gray-900 text-white rounded-xl font-medium hover:bg-gray-800 transition-colors shadow-lg shadow-gray-900/20 flex items-center justify-center gap-2 disabled:opacity-40"
              >
