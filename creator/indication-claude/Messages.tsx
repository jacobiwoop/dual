...
import { Send, Image as ImageIcon, Gift, Zap, Ban, StickyNote, Info, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function Messages({ selectedConversationId, onSelectConversation, conversations }: MessagesProps) {
  ...
  return (
    <div
      className="flex flex-col h-screen bg-white relative select-none md:select-auto"
        ...
        <div className="p-3 md:p-4">
          <div className="flex items-end gap-2 bg-gray-50 p-2 rounded-2xl md:rounded-3xl border border-gray-200 focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-500 transition-all shadow-sm">
            <div className="flex gap-0.5 pb-1 pl-1">
              <button className="p-1.5 md:p-2 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-full transition-colors"><ImageIcon size={18} /></button>
              <button className="p-1.5 md:p-2 text-gray-400 hover:text-pink-600 hover:bg-pink-50 rounded-full transition-colors"><Gift size={18} /></button>
              <button className="p-1.5 md:p-2 text-gray-400 hover:text-yellow-600 hover:bg-yellow-50 rounded-full transition-colors"><Zap size={18} /></button>
            </div>
            <textarea
              value={messageText}
